...
#PBS -t 1-100
#PBS –W stagein=/mnt/work/tb434/mpi@plus7.cluster.univ.kiev.ua:/home/grid/testbed/tb434/5kurs/lab2/mpt

#PBS -W stageout=/mnt/work/tb434/output.task*@plus7.cluster.univ.kiev.ua:/home/grid/testbed/tb434/5kurs/lab2/final
...
if [ $PBS_ARRAYID == 1 ]; then
  ...
  /mnt/work/tb434/mpi > /mnt/work/tb434/output.task$PBS_ARRAYID
fi
